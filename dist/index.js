...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        const commits = +core.getInput(utils_1.Input.Commits);
        const gitName = core.getInput(utils_1.Input.GitName);
        const gitEmail = core.getInput(utils_1.Input.GitEmail);
...
git-email: ${gitEmail}`);
        ...
        yield (0, utils_1.exec)(`git config --local user.name ${gitName}`);
        yield (0, utils_1.exec)(`git config --local user.email ${gitEmail}`);
        const commitCount = +(yield (0, utils_1.getExec)("git rev-list --count HEAD"));
...
(function (Input) {
    ...
    Input["GitName"] = "git-name";
    Input["GitEmail"] = "git-email";
